...
def prepare_block_log(
    output_block_log_directory: Path, signature_type: Literal["open_sign", "multi_sign", "single_sign"]
) -> None:
    """
    ...
    block_log_config = tt.AlternateChainSpecs(
        ...
        hardfork_schedule=[
            ...
            tt.HardforkSchedule(hardfork=current_hardfork_number, block_num=2200 + five_days_in_blocks),
        ],
...
if __name__ == "__main__":
    ...
    prepare_block_log(args.output_block_log_directory, "open_sign")
    prepare_block_log(args.output_block_log_directory, "single_sign")
    prepare_block_log(args.output_block_log_directory, "multi_sign")
